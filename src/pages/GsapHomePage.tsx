  ...
  return (
    <div className="min-h-screen relative bg-[#07070d]">
      ...
      <div className="fixed inset-0 pointer-events-none z-0" aria-hidden="true">
        <div className="absolute top-1/4 -left-1/4 w-[600px] h-[600px] bg-violet-500/[0.05] rounded-full blur-[150px]" />
        <div className="absolute bottom-1/3 right-0 w-[500px] h-[500px] bg-indigo-500/[0.04] rounded-full blur-[130px]" />
        <div className="absolute top-2/3 left-1/3 w-[400px] h-[400px] bg-cyan-500/[0.03] rounded-full blur-[120px]" />
      </div>
      <Navbar theme="gsap" />
      <GsapHero />
